...
public:
	LEADS_Input in;
	LEADS_Laser();
	void LaserProfile(double,rowvec,rowvec&,rowvec&,rowvec&);
...
class LEADS_Dynamics
{
 private:
  	...
  	mat posi,velo,momt,accl,bfield,efield,Afield,vT,vKAPPA;
  	cube vRP,vBETA,vBETADOT,vNNU,vAPOT;
  	vec TR,egama;
